        ...
        <div className="relative flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-4 max-w-2xl">
            ...
            <p className="text-sm sm:text-base text-white/85">
              Stay close to the creators who fuel your curiosity. Every follow brings their freshest blogs into your reading flow.
            </p>
          </div>
      ...
      <section className="space-y-4">
        <div>
          ...
          <p className="text-sm text-slate-500">
            Tap a profile to open their profile page or unfollow directly.
          </p>
        </div>
        ...
        {followingList.length === 0 ? (
          ...
          <div className="space-y-4">
            {followingList.map((user, idx) => {
              return (
                <div
                  key={user?._id || `following-${idx}`}
                  className="rounded-4xl border border-slate-100 bg-white/95 p-6 shadow-[0_25px_70px_-55px_rgba(15,23,42,0.7)] hover:border-[#6C5CE7]/40 transition-colors"
                >
