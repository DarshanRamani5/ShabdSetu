...
import { BookOpen, Eye, EyeOff, Heart, Sparkles, Tag, UserPlus, Users } from 'lucide-react'
...
const Profile = () => {
    ...
    if (userError) {
        return (
            <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
                <div className="max-w-md w-full rounded-4xl border border-rose-200 bg-white p-8 shadow-[0_25px_70px_-55px_rgba(15,23,42,0.7)] text-center">
                    <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-rose-100 text-rose-600">
                        <Users className="h-10 w-10" />
                    </div>
                    <h2 className="text-2xl font-bold text-slate-900 mb-3">Unable to Load Profile Settings</h2>
                    <p className="text-slate-600 mb-6">
                        We couldn't load your profile settings. Please try refreshing the page or check your connection.
                    </p>
                    <div className="flex flex-col gap-3">
                        <button
                            onClick={() => window.location.reload()}
                            className="w-full rounded-full bg-[#6C5CE7] px-6 py-3 text-sm font-semibold text-white shadow-lg hover:bg-[#5a4bc4] transition-colors"
                        >
                            Refresh Page
                        </button>
                        <button
                            onClick={() => navigate(RouteSignIn)}
                            className="w-full rounded-full border border-slate-200 px-6 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 transition-colors"
                        >
                            Sign In Again
                        </button>
                    </div>
                    <p className="mt-6 text-xs text-slate-500">
                        If the issue persists, please contact support at <br />
                        <a href="mailto:shabd.setu.blogsite@gmail.com" className="text-[#6C5CE7] hover:underline">shabd.setu.blogsite@gmail.com</a>
                    </p>
                </div>
            </div>
        )
    ...
    return (
        <div className="mx-auto flex max-w-6xl flex-col gap-2 px-4 py-10 sm:px-8 lg:px-12">
            <BackButton />
                ...
                {overviewLoading && !overviewData ? (
                    ...
                    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
                        {statsItems.map((item) => (
                            <div
                                key={item.label}
                                className={`rounded-3xl border border-slate-100 bg-linear-to-br ${item.accent} px-5 py-4 shadow-[0_20px_60px_-50px_rgba(15,23,42,0.8)]`}
                            >
            ...
            <section className="grid gap-4 lg:grid-cols-2">
                <div className="rounded-4xl border border-slate-100 bg-white/95 p-6 shadow-[0_25px_70px_-55px_rgba(15,23,42,0.7)]">
                                                ...
                                                <FormControl>
                                                    <div className="relative">
                                                        ...
                                                        <button
                                                            ...
                                                            aria-label={passwordVisibility.oldPassword ? 'Hide current password' : 'Show current password'}
                                                        >
            ...
            <section className="rounded-4xl border border-slate-100 bg-white/95 p-6 shadow-[0_25px_70px_-55px_rgba(15,23,42,0.7)] space-y-4">
                <div className="flex flex-wrap items-center justify-between gap-4">
                    <div>
