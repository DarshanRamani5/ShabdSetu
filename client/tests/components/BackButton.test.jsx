...
describe("BackButton", () => {
  ...
  it("renders container with default positioning classes", () => {
    renderComponent();
    const container = screen.getByTestId("back-button-container");
    expect(container).toHaveClass("back-button-container");
  ...
  it("applies custom containerClassName when provided", () => {
    renderComponent({ containerClassName: "mt-2" });
    const container = screen.getByTestId("back-button-container");
